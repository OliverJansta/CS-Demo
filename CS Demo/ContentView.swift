...
struct ContentView: View {
    var body: some View {
        NavigationView {
            ScrollView {
                NavigationLink(destination: DeadEndView(), label: {
                ...
                AccountRowView(name: "Společenství Praha 4, Obětí 6.května 553", accNumber: "000000-1846434399", bankNumber: "0800", balance: 3426420.21, currency: "CZK")
